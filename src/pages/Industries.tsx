  ...
  return (
    <>
      ...
      <div className={styles.wrap}>
        <div className={`${styles.grid} ${styles.g2} ${revealed ? styles.revealed : ''}`}>
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>Weekly multi-camera service production</li>
              <li>Fixed monthly contract, agreed service count</li>
              <li>Consistent graphics, titles and stream branding</li>
          ...
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>AGMs, board meetings and investor sessions</li>
              <li>Town halls and internal communications</li>
              <li>Product launches and press conferences</li>
              <li>Private, unlisted or password-controlled delivery</li>
              <li>Attendance, watch-time and Q&amp;A reporting</li>
            </ul>
          ...
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>Multi-day forums and sector reviews</li>
              <li>Remote panellists and hybrid participation</li>
              <li>Captions, transcripts and interpretation feeds</li>
              <li>Donor-ready highlight films and reporting</li>
              <li>Field documentation and content capture</li>
            </ul>
          ...
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>National and ministerial events</li>
              <li>Conferences, launches and commemorations</li>
              <li>Multi-room and overflow feeds</li>
              <li>Redundant power and connectivity planning</li>
              <li>Documented consent, rights and archive handover</li>
            </ul>
          ...
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>White-label broadcast production</li>
              <li>Integration with your stage, PA and LED supplier</li>
              <li>Sub-contract rates and repeat terms</li>
              <li>Named broadcast lead on your production team</li>
              <li>Your branding on the deliverables</li>
            </ul>
          ...
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>Launch and activation broadcasts</li>
              <li>Sponsor and brand graphics packages</li>
              <li>Vertical clip packages for social</li>
              <li>Moderated public streams</li>
          ...
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>Masterclasses, seminars and workshops</li>
              <li>Multi-session series production</li>
              <li>Studio and classroom setups</li>
              <li>Recording library and archive delivery</li>
              <li>Paywalled or private distribution</li>
            </ul>
          ...
          <div className={`${styles.card} ${styles.revealCard}`}>
            ...
            <ul className={`${styles.check} ${styles.revealList}`}>
              <li>Multi-camera crew supply</li>
              <li>Remote and contribution feeds</li>
              <li>Studio and location production</li>
              <li>Live graphics and playback operation</li>
              <li>Programme recording and delivery</li>
            </ul>
