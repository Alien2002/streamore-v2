    ...
    <>
      ...
      <section className={styles.alt}><div className={styles.wrap}>
        ...
        <div className={styles.tableWrap}><table>
          ...
          <tbody>
            <tr><td><strong>Church monthly</strong></td><td>From TZS 1.2M / month</td><td>Four weekly services, consistent crew and graphics, monthly clip package, channel management</td></tr>
            <tr><td><strong>Corporate quarterly</strong></td><td>From TZS 3.5M / quarter</td><td>One town hall or webinar per month, standing production plan, reporting after each broadcast</td></tr>
            <tr><td><strong>Event series</strong></td><td>Negotiated per season</td><td>Multi-episode or multi-city productions with locked crew, look and delivery calendar</td></tr>
            <tr><td><strong>Partner / white-label</strong></td><td>Sub-contract day rates</td><td>Broadcast crew supplied under your brand for agencies, venues and AV suppliers</td></tr>
          </tbody>
        </table></div>
      </div></section>
      ...
      <section className={styles.deep}><div className={styles.wrap}><div className={styles.secHead + " " + styles.center}><p className={styles.eyebrow}>Choosing a package</p><h2>Pick by risk, not by camera count</h2><div className={styles.rule}></div></div>
        <div className={styles.tableWrap} style={{ background: 'transparent' }}><table>
          <thead><tr><th>If this is true</th><th>Choose</th><th>Because</th></tr></thead>
          <tbody>
            <tr><td>One room, one speaker, forgiving audience</td><td><strong>Basic</strong></td><td>A clean single-angle stream with reliable sound is enough</td></tr>
            <tr><td>External stakeholders, slides, a brand to protect</td><td><strong>Professional</strong></td><td>Direction, graphics and a rehearsal remove the visible mistakes</td></tr>
            <tr><td>Remote participants, two languages, multi-day agenda</td><td><strong>Broadcast</strong></td><td>Hybrid interaction and redundancy become the core requirement</td></tr>
            <tr><td>Outdoor, multi-room, national profile, live audience at scale</td><td><strong>Custom</strong></td><td>Power, connectivity and command structure must be engineered</td></tr>
          </tbody>
        </table></div>
      </div></section>
    </>
